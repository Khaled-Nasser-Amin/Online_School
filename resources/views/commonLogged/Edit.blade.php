        ...
        <div class="row">
                    ...
                    <div class="text-left m-t-40">
                        <ul class="nav edit_list">
                            ...
                            @if($user->getTable() == "school")
                                ...
                                <li class="nav-item"><a href="#user_code" data-toggle="tab" class="nav-link" aria-expanded="false">Display Users's Codes</a></li>
                            @endif
                            @if($user->getTable() == "teacher" || $user->getTable() == "student")
                                <li class="nav-item"><a href="#Subject_Grade" data-toggle="tab" class="nav-link" aria-expanded="false">Change Grade & Subjects</a></li>
                            @endif
                            @if($user->getTable() == "parents")
                                <li class="nav-item"><a href="#add_child" data-toggle="tab" class="nav-link" aria-expanded="false">{{$user->getTable()}}</a></li>
                            @endif
                            @if($user->getTable() == "student")
                                <li class="nav-item"><a href="#user_code" data-toggle="tab" class="nav-link" aria-expanded="false">Display Parent's Code</a></li>
                            @endif
            ...
            <div class="col-md-8 col-lg-9 text-center" style="margin: 40px 0">
                <div class="tab-content">
                    <div style="max-width: 20rem;margin: auto"  class="tab-pane" id="add_child">
                        <form role="form" method="post" action="">
                            <div class="form-group">
                                <label>Child's Code</label>
                                <input type="text" name="child_code" class="form-control">
                            </div>
                            <div class="form-group">
                    ...
                    <div style="max-width: 20rem;margin: auto"  class="tab-pane" id="Subject_Grade">
                        <div class="formstudent form-group change_subject">
                            <p> Your Subjects : <b></b></p>
                            <p> Your Level : <b></b></p>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="add_subject">
                                        ...
                                        <form method="POST" action="">
                                            <input type="Submit" name="teach_subject" value="Submit" id="submit" class="btn btn-primary btn_submit" />
                                        </form>
                                    </div>
                                </div>
                            </div>
                ...
                @if($user->getTable() != 'school')
                    <div class="tab-pane {{session()->has('tabPane') && session()->get('tabPane') == "birthday" ? "active": ''}}" id="Birthday">
                        <div class="form-group formstudent birthday_localaddress">
                            <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <form method="POST" action="{{route('ChangeLocalAddress')}}">
                                    ...
                                    @enderror
                                    <div class="form-group">
                                        <input type="submit" value="Save" name="save_localaddress" class="btn btn-primary waves-effect waves-light w-md">
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <form method="post" action="">
                                <div class="form-group add_subject">
                                    <input style="display: inline;" type="radio" name="yes" value="yes">
                                    <label>Are you wanna <b>delet</b> this Account</label>
                                </div>
                ...
                @if($user->getTable() == "school")
                    ...
                    <div style="max-width: 20rem;margin: auto"  class="tab-pane {{session()->has('tabPane') && session()->get('tabPane') == "addMaterial" ? "active": ''}}" id="add_material">
                        ...
                        @for ($i = 0; $i < count($errors->all()); $i++)
                            @error('name'.$i)
                                <div class="form-group">
                                    <small class="alert aler-danger text-center">{{$message}}</small>
                                </div>
                            @enderror
                        @endfor
                            ...
                            <div class="form-group">
                                ...
                                <div class="AddLanguagePage">
                                    <div class="container">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add_new_matrial">
                                            Add More subjects
                                        </button>
                                    </div>
                                </div>
                                <!-- Modal -->
                                <div class="modal fade" id="add_new_matrial" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
